...
const ProjectSection = () => {
  return (
    <div className="my-[32px]">
        <p className="text-white text-center text-3xl outfit-700 uppercase my-6">Projects</p>
        <div className="flex gap-6 items-center overflow-scroll mx-4 sm:mx-6">
            {webContent.map((item)=>(
...
const ProjectItem = ({ name,img}:{img:string,name:string,github:string,live:string})=>{

    return(
        <div className="shrink-0 w-[350px] sm:w-[450px]">
