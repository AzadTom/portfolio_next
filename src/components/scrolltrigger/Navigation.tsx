...
const Navigation = () => {
    ...
    return (
        <nav className='sm:flex justify-between items-center text-white px-12 py-8 hidden'>
            <div className='flex gap-6 text-base bbh font-medium'>
                <a href="">Overview</a>
                <a href="">Solutions</a>
                <a href="">Resources</a>
            </div>
            ...
            <div className='flex gap-6 text-base bbh'>
