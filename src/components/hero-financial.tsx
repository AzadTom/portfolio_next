...
export const HeroFinancial = () => {
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      {!isMobile && <DesktopNavigation timelineRef={timelineRef} />}
      {/* Hero Content */}
      ...
      <div className="w-full max-w-7xl mx-auto rounded-xl relative mt-10">
        ...
        >
          <TimelineAnimation
            ...
            // @ts-ignore
            src={
              "https://www.ui-layouts.com/_next/static/media/e-commerce-dash.caecb6b7.png"
            }
            alt="phoneMockUP"
...
const MobileNavigation = () => {
  return (
    <div className="flex  flex-row-reverse gap-4 justify-between items-center px-5 w-full pt-4">
      <MotionDrawer
        direction="right"
        width={300}
      ...
      <div className="flex items-center gap-2 text-black z-50">
        <svg
          className="fill-black w-8 h-8"
          width="97"
          height="108"
