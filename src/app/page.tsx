    ...
    <main>
      ...
      >
        <div className="text-white flex flex-col items-center justify-center mt-[12rem] sm:mt-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center mt-[32px]">
            <button className="bg-white  w-full sm:w-[170px] text-black rounded-full h-[45px] px-[24px] py-[12px]  outfit-500 flex justify-center items-center">{"Let's Talk"}</button>
...
const GradientBorderButton = ({ children }: { children: ReactNode }) => {
  return (
    <div className="w-full sm:w-[170px] inline-block p-[1px] rounded-full bg-[linear-gradient(90deg,_#FFDEDE_0%,_#F67A7A_36%,_#D4D9FF_69%,_#DC79FF_100%)]">
